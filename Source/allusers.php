...
<thead>
		...
		while ($row2 = mysqli_fetch_assoc($res2)) {
			...
			echo "<tr><td valign='top'><a href='".User::getavatar($row2['id'])."'><img src='".User::getavatar($row2['id'])."' style='width:50px;height:50px;vertical-align:middle'></a></td>
			...
			<td><font style='vertical-align:middle'> ".Convert::convertdate($row2['Last_Active'])."</font></td>
			</tr>";
		}
echo "</tbody>
            </table>
