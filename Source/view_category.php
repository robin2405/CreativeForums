...
<thead>
        ...
        while ($row = mysql_fetch_assoc($res2)) {
            ...
            $topics .= "<tr><td>".hot($row['topic_views'], $Root, $getTheme)."<td><a href='view_topic.php?cid=".$cid."&tid=".$tid."'>".$title."</a><br /><span class='post_info'>Posted by: ".getusername($creator)." on ".convertdate($date)."</span></td><td align='center' style=''>".$last_user."</td><td>replies:<br />views:</td><td>".topic_replies($cid, $tid)." <br /> ".$views."</td></tr>";
            }
        $topics .= "</tbody>
            </table>
			</div>";
